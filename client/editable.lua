...
function CanUseWorkshop(workshop)
    return (ESX.PlayerData.job and ESX.PlayerData.job.name == workshop.jobWorkshop and ESX.PlayerData.job.grade >= workshop.permissions.swapJobGrade) or workshop.playerWorkshop
end
function CanUsePurchaseEngines(workshop)
    return (ESX.PlayerData.job and ESX.PlayerData.job.name == workshop.jobWorkshop and ESX.PlayerData.job.grade >= workshop.permissions.purchaseEngineJobGrade) or workshop.playerWorkshop
end
